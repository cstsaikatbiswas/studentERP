                ...
                <div class="col-12">
                    <div class="card shadow">
                        <div class="card-header bg-primary text-white">
                            <h6 class="mb-0">
                                <i class="fas fa-info-circle mr-1"></i> Institute Information
                            </h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="institutes/add" id="addInstituteForm">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted">Full name of the institute</small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-lg">
                                        <i class="fas fa-save mr-1"></i> Add Institute
                                    </button>
...
$(document).ready(function() {
    ...
    $('#addInstituteForm').on('submit', function(e) {
        ...
        if (!codeRegex.test(code)) {
            e.preventDefault();
            alert('Institute code can only contain letters, numbers, and underscores.');
            return false;
        }
    });
